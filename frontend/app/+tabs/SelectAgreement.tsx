...
export default function SelectAgreement () {
    ...
    const handleSelectType = (typeId: string) => {
        const selected = typeId as AgreementType;
                ...
                {agreementObjects.map((type) => {
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            style={[
                                Selectstyles.card,
                                { backgroundColor: isChocoMode ? "#61361eff20" : "#fcf4f0ff" }
                            ]}
                        ...
                        >
                            ...
                            {/* 👉 ONLY THESE TURN BLACK IN CHOCO MODE */}
                            <Text style={[
                                Selectstyles.cardTitle,
                                { color: isChocoMode ? "#000000" : "#61361eff" }
                            ]}>
                                {type.title}
                            </Text>

                            <Text style={[
                                Selectstyles.cardDescription,
                                { color: isChocoMode ? "#000000" : "#61361eff" }
                            ]}>
                                {type.description}
                            </Text>
