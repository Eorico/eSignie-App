...
export default function CreateAgreement() {
  ...
  return (
    <ScrollView 
      style={CreateAgreementstyles.container}
      ...
      <View style={CreateAgreementstyles.content}>
        ...
        <View style={[
          ...
          <View style={{ flexDirection: 'row', marginBottom: 10 }}>
            ...
            >
              <Text style={{ color: currentType === 'party' ? '#fff' : '#000', fontWeight: 'bold' }}>Party</Text>
            </TouchableOpacity>
            ...
            onPress={() => setCurrentType('witness')}
              ...
              <Text  style={{ color: currentType === 'witness' ? '#fff' : '#000', fontWeight: 'bold' }}>Witness</Text>
            </TouchableOpacity>
          ...
          <ScrollView nestedScrollEnabled showsVerticalScrollIndicator>
            ...
            {(currentType === 'party' ? parties : witnesses).map((party, i) => (
              ...
              <TextInput
                  style={[CreateAgreementstyles.input, {marginBottom: 8, borderColor: invalidFields.parties[i]?.address ? 'red': '#632402ff'}]}
                  value={party.address}
                  onChangeText={(v) => updatePerson(i, 'address', v)}
                  placeholder="Address"
                  placeholderTextColor="#484b4fbd"
              />
